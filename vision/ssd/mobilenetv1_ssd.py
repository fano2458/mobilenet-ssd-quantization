...
def create_mobilenetv1_ssd(num_classes, is_test=False, device=None, quantized=False):
    ...
    return SSD(num_classes, base_net, source_layer_indexes,
               extras, classification_headers, regression_headers, is_test=is_test, config=config, device=device, quantized=quantized)
