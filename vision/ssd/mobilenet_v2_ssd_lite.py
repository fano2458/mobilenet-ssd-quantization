...
def create_mobilenetv2_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False, quantized=False, device=None):
    ...
    extras = ModuleList([
        InvertedResidual(1280, 512, stride=2, expand_ratio=0.2, onnx_compatible=onnx_compatible),
        InvertedResidual(512, 256, stride=2, expand_ratio=0.25, onnx_compatible=onnx_compatible),
        InvertedResidual(256, 256, stride=2, expand_ratio=0.5, onnx_compatible=onnx_compatible),
        InvertedResidual(256, 64, stride=2, expand_ratio=0.25, onnx_compatible=onnx_compatible)
    ])
    ...
    return SSD(num_classes, base_net, source_layer_indexes,
               extras, classification_headers, regression_headers, is_test=is_test, config=config, quantized=quantized, device=device)
